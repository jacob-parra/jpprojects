...
<a href="https://tailscale.com/download">Download Here</a>
...
Open Powershell as an Admin. Enable Tailscale subnet routing with this command: `tailscale up --advertise-routes=192.168.0.0/24`. 

Approve this route in the <a href="https://login.tailscale.com/admin/machines">Tailscale Admin Console</a> by clicking "Approve" next to the “Subnet routes available” popup banner.
