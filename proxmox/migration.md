...
**NOTE** This method of migration assumes you have one Proxmox server with VMs and configurations (original server), and another fresh install of Proxmox on another machine (new server) on the same LAN. Follow the [Dedicated Proxmox Server](/jpprojects/proxmox/proxmox) project page if needed
