...
- Run `sudo tailscale up --advertise-routes=192.168.10.0/24` to turn on Tailscale . Tailscale will return a link to sign in to with your Tailscale account on another browser. After signing in, go to the Tailscale Admin Console to approve the route and rename the machine if desired.

<div class="info">
The exact route in this last command may differ, specifically the route being advertised. Make sure it matches your LAN subnet. Double check your Tailscale configurations.
</div>
